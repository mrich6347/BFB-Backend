...
export class CategoryGroupsService {
  ...
  async remove(id: string, userId: string, authToken: string): Promise<CategoryGroupDeleteResponse> {
    const supabase = this.supabaseService.getAuthenticatedClient(authToken);
  ...
  async hide(id: string, userId: string, authToken: string): Promise<CategoryGroupDeleteResponse> {
    const supabase = this.supabaseService.getAuthenticatedClient(authToken);
